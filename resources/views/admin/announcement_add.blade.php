...
<body>
    <div class="announcement">
        <h1>ANNOUNCEMENT</h1>
            <form class="uploading" method="POST" action="{{route('admin_announcement_new_check')}}">
                @csrf
                ...
                <span class="icon">
                    ...
                    <input type="text" class="caption" placeholder="Enter Video Link" name="video_link" required>  
                <br><br>
                    
                    <input type="text" class="caption" placeholder="Enter Content" name="content">
