            ...
            <div class="perfs">
                ...
                <div class="criteria">
                    <span>Musicality</span>
                        <div class="rate">
                            <input type="radio" id="star5" name="music" value="5" />
                            <label for="star5" title="text">5 stars</label>
                            <input type="radio" id="star4" name="music" value="4" />
                            <label for="star4" title="text">4 stars</label>
                            <input type="radio" id="star3" name="music" value="3" />
                            <label for="star3" title="text">3 stars</label>
                            <input type="radio" id="star2" name="music" value="2" />
                            <label for="star2" title="text">2 stars</label>
                            <input type="radio" id="star1" name="music" value="1" />
                ...
                <div class="criteria">
                    <span>Originality</span>
                        <div class="rate2">
                            <input type="radio" id="star10" name="originality" value="5" />
                            <label for="star10" title="text">5 stars</label>
                            <input type="radio" id="star9" name="originality" value="4" />
                            <label for="star9" title="text">4 stars</label>
                            <input type="radio" id="star8" name="originality" value="3" />
                            <label for="star8" title="text">3 stars</label>
                            <input type="radio" id="star7" name="originality" value="2" />
                            <label for="star7" title="text">2 stars</label>
                            <input type="radio" id="star6" name="originality" value="1" />
                ...
                <div class="criteria">
                    <span>Choreography</span>
                       <div class="rate3">
                            <input type="radio" id="star15" name="choreography" value="5" />
                            <label for="star15" title="text">5 stars</label>
                            <input type="radio" id="star14" name="choreography" value="4" />
                            <label for="star14" title="text">4 stars</label>
                            <input type="radio" id="star13" name="choreography" value="3" />
                            <label for="star13" title="text">3 stars</label>
                            <input type="radio" id="star12" name="choreography" value="2" />
                            <label for="star12" title="text">2 stars</label>
                            <input type="radio" id="star11" name="choreography" value="1" />
                ...
                <div class="criteria">
                    <span>Personality</span>
                        <div class="rate4">
                            <input type="radio" id="star20" name="personality" value="5" />
                            <label for="star20" title="text">5 stars</label>
                            <input type="radio" id="star19" name="personality" value="4" />
                            <label for="star19" title="text">4 stars</label>
                            <input type="radio" id="star18" name="personality" value="3" />
                            <label for="star18" title="text">3 stars</label>
                            <input type="radio" id="star17" name="personality" value="2" />
                            <label for="star17" title="text">2 stars</label>
                            <input type="radio" id="star16" name="personality" value="1" />
                ...
                <div class="criteria">
                    <span>Memory</span>
                        <div class="rate5">
                            <input type="radio" id="star25" name="memory" value="5" />
                            <label for="star25" title="text">5 stars</label>
                            <input type="radio" id="star24" name="memory" value="4" />
                            <label for="star24" title="text">4 stars</label>
                            <input type="radio" id="star23" name="memory" value="3" />
                            <label for="star23" title="text">3 stars</label>
                            <input type="radio" id="star22" name="memory" value="2" />
                            <label for="star22" title="text">2 stars</label>
                            <input type="radio" id="star21" name="memory" value="1" />
